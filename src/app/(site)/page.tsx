...
export default function Home() {
  return (
    <main className="relative z-0 min-h-screen bg-[var(--background)] pb-24" dir="ltr">
      <section className="flex flex-col items-center justify-center pt-12 px-6 pb-2">
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto w-full">
          <div className="relative w-full max-w-[620px] md:max-w-[800px] aspect-square mx-auto">
            <video
              autoPlay
              loop
              muted
      ...
      <section className="w-full bg-gray-950 pt-2 pb-32 px-4 md:px-12 lg:px-24 transform -translate-y-16 md:-translate-y-24">
        <div className="content-block max-w-5xl w-full mx-auto flex flex-col gap-6" dir="rtl">
          <div className="bg-white/5 rounded-xl p-6 md:p-8 flex flex-col mx-3 md:mx-0">
            <div className="w-full max-w-[92%] mx-auto md:max-w-none">
            <h2 className="text-2xl md:text-5xl font-bold text-[#EEEEEE] pb-3 md:pb-4 mb-4 md:mb-6 border-b border-white/20">
              מה זה RIDERS?
              <br className="md:hidden" />
              <span className="md:whitespace-nowrap"> קהילת שליחי האופניים בפתח תקווה</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-200 mb-3 md:mb-4 leading-relaxed font-medium px-4 md:px-0">
              שליח אופניים בפתח תקווה? נמאס לך לעבוד לבד?
            </p>
            <p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 md:mb-6 leading-relaxed px-4 md:px-0">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-200 leading-relaxed px-4 md:px-0">
          ...
          <div className="bg-white/5 rounded-xl p-6 md:p-8 flex flex-col mx-3 md:mx-0">
            ...
            <ul
              className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 md:mb-6 leading-relaxed space-y-2 md:space-y-3 list-disc list-inside marker:text-[var(--primary)]"
              style={{ paddingInlineStart: 0, paddingInlineEnd: "18px" }}
            >
          ...
          <div className="bg-white/10 rounded-xl p-6 md:p-8 flex flex-col mt-8 md:mt-12 mx-3 md:mx-0">
            <div className="w-full max-w-[92%] mx-auto md:max-w-none">
            <h2 className="text-2xl md:text-5xl font-bold text-[#EEEEEE] pb-3 md:pb-4 mb-4 md:mb-6 border-b border-white/20">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-200 mt-4 leading-relaxed px-4 md:px-0">
              הצעד הראשון פשוט וחינם —{" "}
              <Link
                href="/join"
                className="text-[var(--primary)] font-bold underline underline-offset-2 hover:text-[var(--primary-dark)] transition-colors cursor-pointer"
              >
                הצטרף עכשיו
              </Link>
            </p>
